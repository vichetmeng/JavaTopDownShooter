...
/**
 * The <code>DefeatedScene</code> class displays the appropriate defeat messages once the <code>Player</code>
 * dies/loses.
 * 
 * @author Vichet Meng
 * @version 1.0
 */
public class DefeatedScene implements Initializable {
	...
	@FXML
	private ImageView iGuessText;
	@FXML
	private ImageView saltyText;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		startTimer.schedule(new TimerTask() {
        	/**
        	 * Runs a Timer/TimerTask which changes the <code>DefeatedScene</code> text ImageViews
        	...
        	public void run() {
        		...
        		case 0:
        			...
        			iGuessText.setVisible(true);
        			saltyText.setVisible(true);
        			break;
        		case 1:
        			cycleSelection = 0;
        			playAgainText.setVisible(false);
        			iGuessText.setVisible(false);
        			saltyText.setVisible(false);
        			break;
        		default:
        			cycleSelection = 1;
        			playAgainText.setVisible(true);
